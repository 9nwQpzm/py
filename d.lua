...
freeCamBtn.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/9nwQpzm/py/refs/heads/main/2"))()
end)

-- Copy Hat IDs Button Logic
copyHatBtn.MouseButton1Click:Connect(function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/9nwQpzm/py/refs/heads/main/cc.lua"))()
end)
